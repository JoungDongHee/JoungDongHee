        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-12 text wow fadeInLeft">
                    <h1>Please Login</h1>
                    <form action="./MemberLoginAction.se?NAME=${memberBean.ID}" method="post" class="form-signin" role="form">
                        <input type="text" name="id" class="form-control" placeholder="Id" id="name" required="required" autofocus>
                        <input type="password" name="pass" class="form-control" placeholder="Password" id="age" required="required">
